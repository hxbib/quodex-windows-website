...
export function loginFootnote(): string {
  return isNativeApp()
    ...
    : "This live Windows 11 page uses sample accounts. Tokens are not stored here. Download the Windows app to sign in — sessions are sealed with Windows DPAPI and expired tokens are never retried.";
}
...
export function emptyFootnote(): string {
  return isNativeApp()
    ...
    : "This website is a live desktop preview with sample data. Download the Windows app for DPAPI-backed sessions on your PC.";
}
